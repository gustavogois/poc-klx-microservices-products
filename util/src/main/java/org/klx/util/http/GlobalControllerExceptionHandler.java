 ...
 *
 * For example, if an API implementation class throws InvalidInputException, the utility class will map it to an
 * HTTP response with the status code set to 422 (UNPROCESSABLE_ENTITY).
 */
